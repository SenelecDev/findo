...
/* Smarty version 4.3.1, created on 2023-06-15 18:10:10
  from 'C:\laragon\www\findo\content\themes\default\templates\_sign_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_648b540273b464_99096145',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f968b9604b484c0d660f9c4d4a77239f1b800d78' => 
    array (
      0 => 'C:\\laragon\\www\\findo\\content\\themes\\default\\templates\\_sign_form.tpl',
      1 => 1685449742,
      2 => 'file',
    ),
  ),
...
function content_648b540273b464_99096145 (Smarty_Internal_Template $_smarty_tpl) {
...
/reset"><?php echo __("Forgotten password?");?>
        ...
        <div class="form-group d-grid">
          <button type="submit" class="btn btn-lg btn-primary bg-gradient-blue"><?php echo __("Login");?>
</button>
        </div>
        <!-- submit -->
        <!-- error -->
...
/static/privacy" target="_blank"><?php echo __("Privacy Policy");?>
        ...
        <!-- submit -->
        <div class="form-group d-grid">
          <button type="submit" class="btn btn-lg btn-success bg-gradient-green"><?php echo __("Sign Up");?>
</button>
        </div>
        <!-- submit -->
        <!-- error -->
